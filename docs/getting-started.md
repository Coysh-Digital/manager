...
```bash
git clone --branch v1.4.0 https://github.com/Coysh-Digital/manager.git /opt/manager
...
MANAGER_VERSION=1.4.0   # which release this is; the interface says "unreleased build" without it
```
