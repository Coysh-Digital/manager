...
```bash
git clone --branch v1.3.1 https://github.com/Coysh-Digital/manager.git /opt/manager
...
MANAGER_VERSION=1.3.1   # which release this is; the interface says "unreleased build" without it
```
