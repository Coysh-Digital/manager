...
```bash
git clone --branch v1.3.0 https://github.com/Coysh-Digital/manager.git /opt/manager
...
MANAGER_VERSION=1.3.0   # which release this is; the interface says "unreleased build" without it
```
